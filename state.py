...
class MailRoomState(BaseModel):
    ...
    user_input: str
    """ This is the query input from the user to ask question about our AI mailroom, 
    it can be a question or a request for information related to the mailroom, packages, recipients, etc. """
    ...
    maxtry: Optional[int] = Field(default=3, description="Maximum number of attempts allowed for the user to get a valid response.")
